...
//		System.setProperty(OSSymbolConstants.PERSISTENCE_CONTEXT, "de.aquadiva.test.jpa.ontologyselection");
		registry = RegistryBuilder.buildAndStartupRegistry(OSProcessesModule.class);
	}
	...
	public void testSetupSelectionSystem() throws Exception {
		...
		String classOntologyMappingFile = symbolSource.valueForSymbol(OSSymbolConstants.MIXEDCLASS_ONTOLOGY_MAPPING);
